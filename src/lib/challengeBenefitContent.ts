...
export const CHALLENGE_BENEFIT_CONTENT: ChallengeBenefitContent[] = [
  // Challenge 1: Reduce false declines (Pre-auth only) - GMV uplift
  {
    ...
    benefitDescription: 'Forter\'s automated decisioning allows merchants to say "yes" to more good customers, instantly capturing incremental revenue that was previously being left on the table.',
    benefitPoints: [
  ...
  // Challenge 1: Reduce fraud chargebacks - Cost reduction
  {
    ...
    benefitDescription: 'Forter provides highly accurate, real-time fraud decisions that stop bad actors before the transaction is even processed.',
    benefitPoints: [
  ...
  // Challenge 2/4/5: Pre-auth + 3DS optimization - GMV uplift
  {
    ...
    benefitDescription: 'Forter optimizes the payment flow by intelligently applying SCA exemptions where risk is low, ensuring a frictionless checkout for the majority of users.',
    benefitPoints: [
  ...
  // Challenge 3: Manual review - Cost reduction
  {
    ...
    benefitDescription: 'By automating 100% of decisions, Forter removes the need for manual intervention, providing instant "approve" or "decline" results.',
    benefitPoints: [
  ...
  // Challenge 7: Chargeback disputes - Revenue recovery
  {
    ...
    benefitDescription: 'Forter automates the representment process, using vast identity data to build winning cases against illegitimate chargebacks.',
    benefitPoints: [
  ...
  // Challenge 8: Returns abuse
  {
    ...
    benefitDescription: 'Forter identifies known return abusers before they checkout, allowing merchants to dynamically adjust return policies or block the transaction entirely.',
    benefitPoints: [
  ...
  // Challenge 8: INR abuse
  {
    ...
    benefitDescription: 'Forter\'s identity network tracks personas across the ecosystem to flag individuals with a history of filing false INR claims.',
    benefitPoints: [
  ...
  // Challenge 9: Instant refunds - CX uplift
  {
    ...
    benefitDescription: 'By identifying trusted identities in real-time, Forter allows merchants to safely offer instant refunds to their best customers, turning a standard return into a loyalty-building moment.',
    benefitPoints: [
  ...
  // Challenge 9: Instant refunds - CS OpEx
  {
    ...
    benefitDescription: 'Automating the refund decisioning process with Forter reduces the volume of status-related inquiries and manual approvals required from your staff.',
    benefitPoints: [
  ...
  // Challenge 10/11: Promotion abuse
  {
    ...
    benefitDescription: 'Forter\'s identity network links seemingly disparate accounts to the same individual, effectively blocking multi-accounting and reseller activity.',
    benefitPoints: [
  ...
  // Challenge 12: ATO OpEx savings
  {
    ...
    benefitDescription: 'Forter blocks Account Takeover (ATO) attempts at the front door, preventing the need for expensive post-incident remediation and manual labor.',
    benefitPoints: [
  ...
  // Challenge 13: ATO CLV loss
  {
    ...
    benefitDescription: 'By securing the account journey without adding friction for legitimate owners, Forter preserves the trust that is foundational to long-term customer relationships.',
    benefitPoints: [
  ...
  // Challenge 14: Marketing budget protection
  {
    ...
    benefitDescription: 'Forter accurately identifies unique identities at the point of sign-up, ensuring that acquisition incentives only go to truly new customers.',
    benefitPoints: [
  ...
  // Challenge 15: KYC cost optimization
  {
    ...
    benefitDescription: 'Forter filters out fraudulent and bot-driven sign-ups before they reach the verification stage, ensuring merchants only pay for legitimate prospects.',
    benefitPoints: [
